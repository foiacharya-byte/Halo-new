...
class Service(Envelope):
    ...
    website: str = ""                    # official site (OSM website / Wikidata P856)
    opening_hours: str = ""              # OSM opening_hours
    attributes: dict = field(default_factory=dict)  # cuisine, brand, operator, email, ...
